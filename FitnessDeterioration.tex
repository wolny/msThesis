...
\begin{figure}
  \centering
  \fbox{
    \includegraphics[scale=0.25]{clusterDensity/cluster1.pdf}
  }
  \fbox{
    \includegraphics[scale=0.25]{clusterDensity/cluster2.pdf}
  }
...
This might be shown for sample data (see Figure 4.3) by using its
...
\begin{figure}
  \centering
  \fbox{
    \includegraphics[scale=0.25]{clusterDensity/cluster12.pdf}
  }
  \fbox{
    \includegraphics[scale=0.25]{clusterDensity/cluster22.pdf}
  }
...
\WHILE{$\epsilon' > treshold$}
	...
	\STATE {$mse = getMSE(crunchingFunctions, currentFitness, clusters)$}
	\IF{$mse < minMse$}
		\STATE {$saveBestCrunching(mse, crunchingFunctions)$}
	\ENDIF
...
\begin{figure}
  ...
  \fbox{
    \includegraphics[scale=0.3]{clusterExtraction/dataSet.png}
  }
  \fbox{
    \includegraphics[scale=0.4]{clusterExtraction/reachabilityPlot1.png}
  }
  \fbox{
    \includegraphics[scale=0.3]{clusterExtraction/clusters.png}
  }
